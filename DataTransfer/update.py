...
try:
   ...
   #El data frame debe estar filtrado por datos nuevos o no se podra actualizar
    ...
    async def save_companies():
        await Repository.update_table_companies(company_data)
    
    async def save_charges():
        await Repository.update_table_charges(charge_data)
